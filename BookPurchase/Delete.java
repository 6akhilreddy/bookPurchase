...
public class Delete extends JApplet implements ActionListener{
...
AdminSearch p=new AdminSearch(c2.getSelectedItem(),c3.getSelectedItem(),l7.getText(),l12.getText());
//p.setVisible(true);
	}  
});
...
String m=l2[id].getText(); 
  ...
  try{
		...
		ResultSet rs=stmt.executeQuery("delete  adminadd where bname='"+m+"'");  
		
		
		
		con.close();
		
		JOptionPane.showMessageDialog(null,"Deleted Book: "+m+"");

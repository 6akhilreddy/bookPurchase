...
public class AdminView extends JApplet implements ActionListener{
...
AdminFullpage page=new AdminFullpage(l9.getIcon(),l2[id].getText(),l3[id].getText(),l4[id].getText(),l5[id].getText(),l10.getText(),l12.getText(),l7.getText()); 
